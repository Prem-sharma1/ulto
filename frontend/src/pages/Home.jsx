    ...
    <div className="min-h-screen bg-dark-900 overflow-hidden relative">
      ...
      <nav className="glass sticky top-0 z-50 flex justify-between items-center px-8 py-4">
        ...
        <div className="flex gap-4">
          ...
          <Link to="/register" className="primary-btn text-sm py-2 px-5 !rounded-full">
            Sign up
          </Link>
        </div>
      </nav>
      ...
      <main className="container mx-auto px-6 py-20 flex flex-col lg:flex-row items-center justify-between gap-12 relative z-10">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Link to="/register" className="primary-btn text-center text-lg py-4 w-full sm:w-auto min-w-[200px]">
              Get a Ride
            </Link>
            <Link to="/register" className="glass hover:bg-white/10 text-white font-bold py-4 px-6 rounded-lg text-center transition-colors text-lg w-full sm:w-auto min-w-[200px]">
              Become a Driver
            </Link>
          </div>
        </motion.div>
